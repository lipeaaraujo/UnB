...
HD_PWD='C:/Users/felip/OneDrive/rea de Trabalho/UNB/3 Semestre/TEDVHDL/somador_ripple_carry_4/somador_ripple_carry_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soma4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soma4.tcl
