...
HD_PWD='C:/Users/felip/OneDrive/rea de Trabalho/UNB/3 Semestre/PED/porta_xnor/porta_xnor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xnor2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xnor2.tcl
