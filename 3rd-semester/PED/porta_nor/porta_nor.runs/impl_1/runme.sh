...
HD_PWD='C:/Users/felip/OneDrive/rea de Trabalho/UNB/3 Semestre/PED/porta_nor/porta_nor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nor2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nor2.tcl -notrace
