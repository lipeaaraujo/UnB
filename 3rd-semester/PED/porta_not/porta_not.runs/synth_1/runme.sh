...
HD_PWD='C:/Users/felip/OneDrive/rea de Trabalho/UNB/3 Semestre/PED/porta_not/porta_not.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log not1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source not1.tcl
