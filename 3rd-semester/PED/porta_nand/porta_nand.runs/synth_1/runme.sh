...
HD_PWD='C:/Users/felip/OneDrive/rea de Trabalho/UNB/3 Semestre/PED/porta_nand/porta_nand.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nand2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nand2.tcl
