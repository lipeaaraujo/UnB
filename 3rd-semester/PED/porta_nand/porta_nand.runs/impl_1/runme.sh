...
HD_PWD='C:/Users/felip/OneDrive/rea de Trabalho/UNB/3 Semestre/PED/porta_nand/porta_nand.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nand2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nand2.tcl -notrace
