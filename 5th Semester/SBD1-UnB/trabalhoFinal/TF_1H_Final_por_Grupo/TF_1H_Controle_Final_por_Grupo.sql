...
GRANT ALL PRIVILEGES ON TF_1H_felipearaujo.* TO perfilAdmin;

CREATE ROLE perfilVendedor;
GRANT SELECT, INSERT, UPDATE, DELETE ON TF_1H_felipearaujo.* TO perfilVendedor;

CREATE ROLE perfilLeitor;
GRANT SELECT ON TF_1H_felipearaujo.* TO perfil_leitor;
