...
HD_PWD='C:/Users/felip/OneDrive/rea de Trabalho/UNB/3 Semestre/PED/porta_nor/porta_nor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nor2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nor2.tcl
