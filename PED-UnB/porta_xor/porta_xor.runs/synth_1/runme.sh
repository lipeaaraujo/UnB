...
HD_PWD='C:/Users/felip/OneDrive/rea de Trabalho/UNB/3 Semestre/PED/porta_xor/porta_xor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xor2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xor2.tcl
