...
HD_PWD='C:/Users/felip/OneDrive/rea de Trabalho/UNB/3 Semestre/PED/porta_xor/porta_xor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xor2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xor2.tcl -notrace
