...
HD_PWD='C:/Users/felip/OneDrive/rea de Trabalho/UNB/3 Semestre/TEDVHDL/projeto_ted/projeto_ted.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log teste.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source teste.tcl
