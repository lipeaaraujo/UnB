...
HD_PWD='C:/Users/felip/OneDrive/rea de Trabalho/UNB/3 Semestre/PED/porta_not/porta_not.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log not1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source not1.tcl -notrace
