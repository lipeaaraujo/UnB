...
HD_PWD='C:/Users/felip/OneDrive/rea de Trabalho/UNB/3 Semestre/PED/experimento_1vhdl/experimento_1vhdl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sinal_alarme.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sinal_alarme.tcl
