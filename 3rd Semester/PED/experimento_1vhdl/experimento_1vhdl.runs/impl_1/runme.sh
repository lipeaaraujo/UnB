...
HD_PWD='C:/Users/felip/OneDrive/rea de Trabalho/UNB/3 Semestre/PED/experimento_1vhdl/experimento_1vhdl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sinal_alarme.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sinal_alarme.tcl -notrace
