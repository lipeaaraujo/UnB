...
HD_PWD='C:/Users/felip/OneDrive/rea de Trabalho/UNB/3 Semestre/TEDVHDL/projeto_ted/projeto_ted.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log teste.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source teste.tcl -notrace
