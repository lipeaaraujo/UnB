...
HD_PWD='C:/Users/felip/OneDrive/rea de Trabalho/UNB/3 Semestre/PED/experimento_2/experimento_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log codificador.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source codificador.tcl -notrace
