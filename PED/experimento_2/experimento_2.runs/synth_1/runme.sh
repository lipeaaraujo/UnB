...
HD_PWD='C:/Users/felip/OneDrive/rea de Trabalho/UNB/3 Semestre/PED/experimento_2/experimento_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log codificador.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source codificador.tcl
