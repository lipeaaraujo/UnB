...
HD_PWD='C:/Users/felip/OneDrive/rea de Trabalho/UNB/3 Semestre/PED/porta_xnor/porta_xnor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xnor2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xnor2.tcl -notrace
