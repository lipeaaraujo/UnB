...
INSERT INTO PRODUTO (descricao, precoUnitario, codigoArea, nomeProduto) VALUES
('Notebook com 16GB RAM, 512GB SSD e tela Full HD', 2500.00, 1, 'Notebook Dell'),
('Smartphone com 128GB de armazenamento e câmera tripla', 1500.00, 1, 'Smartphone Samsung'),
('Caneta esferográfica azul, corpo transparente, ponta média', 10.00, 3, 'Caneta Azul'),
('Caderno universitário com 200 folhas pautadas, capa dura', 50.00, 3, 'Caderno 200 folhas'),
('Telefone fixo com identificador de chamadas e viva-voz', 800.00, 4, 'Telefone Fixo Intelbras'),
('Impressora multifuncional com Wi-Fi e scanner integrado', 2300.00, 2, 'Impressora HP'),
('Cadeira ergonômica com regulagem de altura e apoio lombar', 500.00, 6, 'Cadeira Escritório');
...
INSERT INTO tem (codigoVenda, codigoProduto, data, quantidade) VALUES
(1, 1, '2025-04-07', 1),
(1, 2, '2025-04-07', 2),
(2, 3, '2025-04-07', 10),
(3, 4, '2025-04-07', 5),
